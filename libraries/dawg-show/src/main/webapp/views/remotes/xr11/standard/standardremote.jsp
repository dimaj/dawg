...
<html style="width:100%; height:100%">
    ...
    <img id="bg" src='<c:url value="/images/remotes/xr11/bg.png" />' alt="" style="width:100%;height:100%;left:0%;top:0%;position:absolute" usemap="#xr11remote"/>
    ...
    <img id="sd"  src='<c:url value="/images/remotes/xr11/keys/D.png" />' onmousedown="clickRemoteButton(event,'D',  true)" onmouseup="clickRemoteButton(event,'D',  false)" alt="" style="width:12.5%;left:71.7%;top:65.8%;position:absolute"/>
    ...
    <!--
    <img id="stvpower"   src='<c:url value="/images/remotes/xr11/keys/TV.png" />' onmousedown="clickRemoteButton(event,'D',  true)" onmouseup="clickRemoteButton(event,'D',  false)" alt="" style="width:14.7%;left:68.3%;top:6.2%;position:absolute"/>
    -->
    ...
    <img id="sleft"   src='<c:url value="/images/remotes/xr11/keys/Left Arrow.png" />' onmousedown="clickRemoteButton(event,'LEFT', true)" onmouseup="clickRemoteButton(event,'LEFT', false)" alt="" style="width:20.8%;left:17.3%;top:41.9%;position:absolute"/>
    <img id="sright"  src='<c:url value="/images/remotes/xr11/keys/Right Arrow.png" />' onmousedown="clickRemoteButton(event,'RIGHT', true)" onmouseup="clickRemoteButton(event,'RIGHT', false)" alt="" style="width:20.8%;left:61.9%;top:41.9%;position:absolute"/>
    <img id="sdown"   src='<c:url value="/images/remotes/xr11/keys/Down arrow.png" />' onmousedown="clickRemoteButton(event,'DOWN', true)" onmouseup="clickRemoteButton(event,'DOWN', false)" alt="" style="width:58.8%;left:20.6%;top:53.7%;position:absolute"/>
    ...
    <img id="sselect" src='<c:url value="/images/remotes/xr11/keys/Ok.png" />' onmousedown="clickRemoteButton(event,'SELECT', true)" onmouseup="clickRemoteButton(event,'SELECT', false)" alt="" style="width:25.4%;left:37.3%;top:46.5%;position:absolute"/>
    ...
    <img id="sff" src='<c:url value="/images/remotes/xr11/keys/Fast Forward.png" />' onmousedown="clickRemoteButton(event,'FF', true)" onmouseup="clickRemoteButton(event,'FF', false)" alt="" style="width:20.2%;left:64.5%;top:25%;position:absolute"/>
    ...
    <img id="svoice" src='<c:url value="/images/remotes/xr11/keys/Voice.png" />' onmousedown="clickRemoteButton(event,'REC', true)" onmouseup="clickRemoteButton(event,'VOICE', false)" alt="" style="width:29%;left:35.5%;top:30.2%;position:absolute"/>
    ...
    <img id="svoldn" src='<c:url value="/images/remotes/xr11/keys/Volume down.png" />' onmousedown="clickRemoteButton(event,'VOLDN', true)" onmouseup="clickRemoteButton(event,'VOLDN', false)" alt="" style="width:20.4%;left:14.4%;top:18.2%;position:absolute"/>
    <img id="schdn" src='<c:url value="/images/remotes/xr11/keys/Channel down.png" />' onmousedown="clickRemoteButton(event,'CHDN', true)"  onmouseup="clickRemoteButton(event,'CHDN', false)"  alt="" style="width:20.4%;left:65.2%;top:18.2%;position:absolute"/>
    ...
    <img id="ssetup" src='<c:url value="/images/remotes/xr11/keys/Setup.png" />' onmousedown="clickRemoteButton(event,'SETUP', true)" onmouseup="clickRemoteButton(event,'SETUP', false)" alt="" style="width:8.2%;left:21.1%;top:86.7%;position:absolute"/>
